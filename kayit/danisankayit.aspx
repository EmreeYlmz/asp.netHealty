<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="danisankayit.aspx.cs" Inherits="WebApplication1.danisankayit" %>
    ...
    <div class="container">
        <div class="form-section">
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="txtkullanicidanisanad" runat="server" CssClass="form-control oval-input" OnTextChanged="txtDanisanAd_TextChanged"></asp:TextBox>
            </div>
            <div class="form-group">
                <asp:Label ID="lblDiyetisyenAd" runat="server" Text="Ad:"></asp:Label>
                <asp:TextBox ID="txtDanisanAd" runat="server" CssClass="form-control oval-input" OnTextChanged="txtDanisanAd_TextChanged"></asp:TextBox>
            </div>
            <div class="form-group">
                <asp:Label ID="lblDiyetisyenSoyad" runat="server" Text="Soyad:"></asp:Label>
                <asp:TextBox ID="txtDanisanSoyad" runat="server" CssClass="form-control oval-input"></asp:TextBox>
            </div>
            <div class="form-group">
                <asp:Label ID="lblDiyetisyenEmail" runat="server" Text="E-posta:"></asp:Label>
                <asp:TextBox ID="txtDanisanEmail" runat="server" TextMode="Email" CssClass="form-control oval-input"></asp:TextBox>
            </div>
            <div class="form-group">
                <asp:Label ID="lblDiyetisyenPassword" runat="server" Text="Parola:"></asp:Label>
                <asp:TextBox ID="txtDanisanPassword" runat="server" TextMode="Password" CssClass="form-control oval-input" OnTextChanged="txtDanisanPassword_TextChanged"></asp:TextBox>
            </div>
            <div class="form-group">
                <asp:Label ID="lblDiyetisyenPasswordRepeat" runat="server" Text="Parolayı Tekrar Girin:"></asp:Label>
                <asp:TextBox ID="txtDanisanPasswordRepeat" runat="server" TextMode="Password" CssClass="form-control oval-input"></asp:TextBox>
